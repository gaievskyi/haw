...
var becomeFamilyBttns = document.querySelectorAll(".btn-support,.support__btn");
console.log(becomeFamilyBttns);
var msg = "Przekazanie 1% podatku, nr KRS 0000154454, w celu szczegółowym wpisując Schronisko w Mysłowicach\n" + "lub przekazanie darowizny na nasz rachunek bankowy:\n" + "39 1020 2313 0000 3102 0121 3677\n" + "lub\n" + "63 1020 2528 0000 0702 0498 9523\n" + "Przekazanie darowizny w schronisku\n";

_toConsumableArray(becomeFamilyBttns).forEach(function (btn) {
...
var burgerBtn = document.querySelector(".menu-burger");
var burgerInner = document.querySelector(".menu-overlay");
